...
namespace BTL
{
    public partial class formGV : Form
    {
        ...
        void refresh()
        {
            tbMaGV.Text = "Nhập mã GV"; tbMaGV.ForeColor = Color.Gray;
            tbHoTen.Text = "Nhập họ tên GV"; tbHoTen.ForeColor = Color.Gray;
            tbNgaysinh.Text = "mm/dd/yyyy"; tbNgaysinh.ForeColor = Color.Gray;
            tbDiaChi.Text = "Nhập địa chỉ"; tbHoTen.ForeColor = Color.Gray;
            rdoNam.Checked = false;
            rdoNu.Checked = false;
            tbSoDt.Text = "Nhập sđt"; tbHoTen.ForeColor = Color.Gray;
            tbEmail.Text = "Nhập email"; tbHoTen.ForeColor = Color.Gray;
            tbHocHam.Text = "Nhập học hàm"; tbHoTen.ForeColor = Color.Gray;
            tbHocVi.Text = "Nhập học vị"; tbHoTen.ForeColor = Color.Gray;
        ...
        {
            RoundedCorner.DrawRoundedCornerControl(panel2, e);
        }
        ...
        private void tbMaGV_Enter(object sender, EventArgs e)
        {
            if (tbMaGV.Text == "Nhập mã GV")
            {
                tbMaGV.Text = "";
                tbMaGV.ForeColor = Color.Black;
            }
        }

        private void tbMaGV_Leave(object sender, EventArgs e)
        {
            if (tbMaGV.Text == "")
            {
                tbMaGV.Text = "Nhập mã GV";
                tbMaGV.ForeColor = Color.Gray;
            }
        }

        private void tbHoTen_Enter(object sender, EventArgs e)
        {
            if (tbHoTen.Text == "Nhập họ tên GV")
            {
                tbHoTen.Text = "";
                tbHoTen.ForeColor = Color.Black;
            }
        }
        ...
        private void tbHoTen_Leave(object sender, EventArgs e)
        {
            if (tbHoTen.Text == "")
            {
                tbHoTen.Text = "Nhập họ tên GV";
                tbHoTen.ForeColor = Color.Gray;
            }
        }

        private void tbDiaChi_Enter(object sender, EventArgs e)
        {
            if (tbDiaChi.Text == "Nhập địa chỉ")
            {
                tbDiaChi.Text = "";
        ...
        private void tbDiaChi_Leave(object sender, EventArgs e)
        {
            if (tbDiaChi.Text == "")
            {
                tbDiaChi.Text = "Nhập địa chỉ";
                tbDiaChi.ForeColor = Color.Gray;
            }
        }

        private void tbSoDt_Enter(object sender, EventArgs e)
        {
            if (tbSoDt.Text == "Nhập sđt")
            {
                tbSoDt.Text = "";
                tbSoDt.ForeColor = Color.Black;
            }
        }

        private void tbSoDt_Leave(object sender, EventArgs e)
        {
            if (tbSoDt.Text == "")
            {
                tbSoDt.Text = "Nhập sđt";
                tbSoDt.ForeColor = Color.Gray;
            }
        }

        private void tbEmail_Enter(object sender, EventArgs e)
        {
            if (tbEmail.Text == "Nhập email")
            {
                tbEmail.Text = "";
        ...
        private void tbEmail_Leave(object sender, EventArgs e)
        {
            if (tbEmail.Text == "")
            {
                tbEmail.Text = "Nhập email";
                tbEmail.ForeColor = Color.Gray;
            }
        }

        private void tbHocHam_Enter(object sender, EventArgs e)
        {
            if (tbHocHam.Text == "Nhập học hàm")
            {
                tbHocHam.Text = "";
                tbHocHam.ForeColor = Color.Black;
            }
        }

        private void tbHocHam_Leave(object sender, EventArgs e)
        {
            if (tbHocHam.Text == "")
            {
                tbHocHam.Text = "Nhập học hàm";
                tbHocHam.ForeColor = Color.Gray;
            }
        }

        private void tbHocVi_Enter(object sender, EventArgs e)
        {
            if (tbHocVi.Text == "Nhập học vị")
            {
                tbHocVi.Text = "";
                tbHocVi.ForeColor = Color.Black;
            }
        }

        private void tbHocVi_Leave(object sender, EventArgs e)
        {
            if (tbHocVi.Text == "")
            {
                tbHocVi.Text = "Nhập học vị";
                tbHocVi.ForeColor = Color.Gray;
            }
        }
        ...
        private void tbHocHam_TextChanged(object sender, EventArgs e)
        {
        ...
        {
            RoundedCorner.DrawRoundedCornerControl(panel1, e);
        }
    }
}
