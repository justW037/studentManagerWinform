...
namespace BTL
{
    public partial class formLopHC : Form
    {
        ...
        private void tbNamNhapHoc_Enter(object sender, EventArgs e)
        {
            if (tbNamNhapHoc.Text == "Nhập năm học")
            {
                tbNamNhapHoc.Text = "";
                tbNamNhapHoc.ForeColor = SystemColors.WindowText; // Đổi màu văn bản về màu mặc định
            }
        }

        private void tbNamNhapHoc_Leave(object sender, EventArgs e)
        {
            // Hiển thị văn bản placeholder nếu TextBox không được tập trung vào và không có văn bản nào được nhập
            if (tbNamNhapHoc.Text == "")
            {
                tbNamNhapHoc.Text = "Nhập năm học";
                tbNamNhapHoc.ForeColor = SystemColors.GrayText; // Đổi màu văn bản thành màu xám
            }
        }
