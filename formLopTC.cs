...
namespace BTL
{
    public partial class formLopTC : Form
    {
        ...
        private void tbNamHoc_Enter(object sender, EventArgs e)
        {
            if (tbNamHoc.Text == "Nhập năm học")
            {
                tbNamHoc.Text = "";
                tbNamHoc.ForeColor = SystemColors.WindowText; // Đổi màu văn bản về màu mặc định
            }
        }

        private void tbNamHoc_Leave(object sender, EventArgs e)
        {
            if (tbNamHoc.Text == "")
            {
                tbNamHoc.Text = "Nhập năm học";
                tbNamHoc.ForeColor = SystemColors.GrayText; // Đổi màu văn bản thành màu xám
            }
        }
