...
namespace BTL
{
    public partial class formMonHoc : Form
    {
        ...
        private void tbMaMon_Enter(object sender, EventArgs e)
        {
            // Xóa văn bản placeholder nếu TextBox được tập trung vào
            if (tbMaMon.Text == "Nhập mã môn")
            {
                tbMaMon.Text = "";
                tbMaMon.ForeColor = SystemColors.WindowText; // Đổi màu văn bản về màu mặc định
            }
        }

        private void tbMaMon_Leave(object sender, EventArgs e)
        {
            // Hiển thị văn bản placeholder nếu TextBox không được tập trung vào và không có văn bản nào được nhập
            if (tbMaMon.Text == "")
            {
                tbMaMon.Text = "Nhập mã môn";
                tbMaMon.ForeColor = SystemColors.GrayText; // Đổi màu văn bản thành màu xám
            }
        }

        private void tbTenMon_Enter(object sender, EventArgs e)
        {
            // Xóa văn bản placeholder nếu TextBox được tập trung vào
            if (tbTenMon.Text == "Nhập tên môn")
            {
                tbTenMon.Text = "";
                tbTenMon.ForeColor = SystemColors.WindowText; // Đổi màu văn bản về màu mặc định
            }
        }

        private void tbTenMon_Leave(object sender, EventArgs e)
        {
            // Hiển thị văn bản placeholder nếu TextBox không được tập trung vào và không có văn bản nào được nhập
            if (tbTenMon.Text == "")
            {
                tbTenMon.Text = "Nhập tên môn";
                tbTenMon.ForeColor = SystemColors.GrayText; // Đổi màu văn bản thành màu xám
            }
        }

        private void tbSoTC_Enter(object sender, EventArgs e)
        {
            // Xóa văn bản placeholder nếu TextBox được tập trung vào
            if (tbSoTC.Text == "0")
            {
                tbSoTC.Text = "";
                tbSoTC.ForeColor = SystemColors.WindowText; // Đổi màu văn bản về màu mặc định
            }
        }
        ...
        private void tbSoTC_Leave(object sender, EventArgs e)
        {
            ...
            {
                tbSoTC.Text = "0";
                tbSoTC.ForeColor = SystemColors.GrayText; // Đổi màu văn bản thành màu xám
            }
        }
    }
}
