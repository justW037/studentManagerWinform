...
namespace BTL
{
    public partial class formDiem : Form
    {
        ...
        {
            RoundedCorner.DrawRoundedCornerControl(btnRefresh, e);
        }

        private void btnThem_Paint(object sender, PaintEventArgs e)
        {
            RoundedCorner.DrawRoundedCornerControl(btnThem, e);
        }

        private void btnSua_Paint(object sender, PaintEventArgs e)
        {
            RoundedCorner.DrawRoundedCornerControl(btnSua, e);
        }

        private void btnXoa_Paint(object sender, PaintEventArgs e)
        {
            RoundedCorner.DrawRoundedCornerControl(btnXoa, e);
        }
        ...
        private void tbMalop_Enter(object sender, EventArgs e)
        {
            // Xóa văn bản placeholder nếu TextBox được tập trung vào
            if (tbMaLop.Text == "Nhập mã lớp")
            {
                tbMaLop.Text = "";
                tbMaLop.ForeColor = SystemColors.WindowText; // Đổi màu văn bản về màu mặc định
            }
        }

        private void tbMaLop_Leave(object sender, EventArgs e)
        {
            // Hiển thị văn bản placeholder nếu TextBox không được tập trung vào và không có văn bản nào được nhập
            if (tbMaLop.Text == "")
            {
                tbMaLop.Text = "Nhập mã lớp";
                tbMaLop.ForeColor = SystemColors.GrayText; // Đổi màu văn bản thành màu xám
            }
        }
        ...
        private void tbDiemCC_Enter(object sender, EventArgs e)
        {
            if (tbDiemCC.Text == "0")
            {
                tbDiemCC.Text = "";
                tbDiemCC.ForeColor = SystemColors.ActiveCaptionText;
            }
        }

        private void tbDiemCC_Leave(object sender, EventArgs e)
        {
            if (tbDiemCC.Text == "")
            {
                tbDiemCC.Text = "0";
                tbDiemCC.ForeColor = SystemColors.GrayText;
            }
        }

        private void tbMaSV_Enter(object sender, EventArgs e)
        {
            if (tbMaSV.Text == "Nhập mã SV")
            {
                tbMaSV.Text = "";
                tbMaSV.ForeColor = SystemColors.ActiveCaptionText;
            }
        }
        ...
        private void tbMaSV_Leave(object sender, EventArgs e)
        {
            if (tbMaSV.Text == "")
            {
                tbMaSV.Text = "Nhập mã SV";
                tbMaSV.ForeColor = SystemColors.GrayText;
            }
        }
        private void tbDiemGK_Enter(object sender, EventArgs e)
        {
            if (tbDiemGK.Text == "0")
            {
                tbDiemGK.Text = "";
                tbDiemGK.ForeColor = SystemColors.ActiveCaptionText;
            }
        }

        private void tbDiemGK_Leave(object sender, EventArgs e)
        {
            if (tbDiemGK.Text == "")
            {
                tbDiemGK.Text = "0";
                tbDiemGK.ForeColor = SystemColors.GrayText;
            }
        }

        private void tbDiemThi_Enter(object sender, EventArgs e)
        {
            if (tbDiemThi.Text == "0")
            {
                tbDiemThi.Text = "";
                tbDiemThi.ForeColor = SystemColors.ActiveCaptionText;
            }
        }

        private void tbDiemThi_Leave(object sender, EventArgs e)
        {
            if (tbDiemThi.Text == "")
            {
                tbDiemThi.Text = "0";
                tbDiemThi.ForeColor = SystemColors.GrayText;
            }
        }
